...
class NavigationManager {
    ...
    fun open(fragment: Fragment, containerId: Int = fragmentContainerId, openMethod: OpenMethod = OpenMethod.REPLACE,
             addToBackStack: Boolean = true, fragmentTag: String = "") {
        fragmentManager?.let {
    ...
    fun removeTempFragment() {
        fragmentManager?.popBackStackImmediate(TEMP_FRAGMENT, FragmentManager.POP_BACK_STACK_INCLUSIVE)
